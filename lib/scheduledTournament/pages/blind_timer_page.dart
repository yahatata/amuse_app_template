...
class _BlindTimerPageState extends State<BlindTimerPage> {
        ...
        builder: (context, runtimeSnapshot) {
          ...
          return StreamBuilder<DocumentSnapshot>(
            ...
            builder: (context, mainSnapshot) {
              ...
              return _buildMainContent(runtime, screenSize);
            },
          );
        },
      ),
  ...
  Widget _buildMainContent(RuntimeMain runtime, Size screenSize) {
    ...
    return Stack(
      children: [
        ...
        // 画面中央 - ブラインド情報
        _buildCenterContent(progress, runtime, screenSize),
  ...
  Widget _buildCenterContent(StageProgress progress, RuntimeMain runtime, Size screenSize) {
