      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _infoRow('残業割増', '¥${yenFormat.format(d.overtimePremiumPay)}'),
            _infoRow('60h超割増', '¥${yenFormat.format(d.over60PremiumPay)}'),
            _infoRow('法定休日割増', '¥${yenFormat.format(d.legalHolidayPremiumPay)}'),
            const Divider(),
