...
class ScheduledTournamentInCalendarPage extends StatefulWidget {
  const ScheduledTournamentInCalendarPage({super.key});

  @override
  State<ScheduledTournamentInCalendarPage> createState() => _ScheduledTournamentInCalendarPageState();
}

class _ScheduledTournamentInCalendarPageState extends State<ScheduledTournamentInCalendarPage> {
  ...
  void initState() {
    ...
    _loadTournaments();
    // _loadTournamentTemplates()を削除（このページからはトーナメント作成不可）
  }
  ...
  // トーナメント作成関連のメソッドを削除（このページからはトーナメント作成不可）
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBar(
            title: const Text('スケジュール済みトーナメント（カレンダー）'),
