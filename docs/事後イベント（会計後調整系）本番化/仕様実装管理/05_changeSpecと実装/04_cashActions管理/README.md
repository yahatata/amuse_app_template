# 04_cashActions管理 README

## 1. このステップの役割

このフォルダは、対応する仕様書 `../04_仕様書/04_cashActions管理.md` を入力として、04_cashActions管理 に関する changeSpec / 実装 / 確認を一貫して管理するための作業フォルダである。
...
- 推奨 changeSpec 名: `CS04_cashActions管理`
