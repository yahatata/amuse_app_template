...
- `07(+08)_schedulerとCloudTasks確認` — 技術確認（動作・ログ・検知）。給与通知も他 job と同様
- `11_requiredStaffByTimeSlot方針`

## 07(+08) との切り分け（合意済み）

- **07(+08)**: 通知経路を他 scheduled job と同様に **動く・ログ・検知** 可能な状態に保つ
- **12（本タスク）**: 通知機能を **本当に必要か・中身の調整が必要か** を検討し、必要なら修正する
