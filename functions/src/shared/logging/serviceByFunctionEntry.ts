...
export const SERVICE_BY_FUNCTION_ENTRY: Record<string, string> = {
  ...
  // public wrapper 削除後も internal `runCleanupActiveStays` がこの論理 FE で logOps する
  ...
  // public wrapper 削除後も internal `runMigrateSettledBillsForBusinessDay` がこの論理 FE で logOps する
