...
const s13 = [
  ...
  ["close_process", "updateUnclockedAttendanceWithAuth", "src/domains/storeMeta/callables/updateUnclockedAttendanceWithAuth.ts", "122-135", "catch", "logOpsError", "実装済み", "対象外確定", "§13#8"],
  ["close_process", "applyCloseSnapshot", "src/domains/storeMeta/services/applyCloseSnapshot.ts", "186-195", "catch", "logOpsError なし（HttpsError 再throw）", "保留", "保留維持", "§13#9"],
  ["close_process", "getCloseIntegrityData", "src/domains/storeMeta/services/getCloseIntegrityData.ts", "49-62", "catch", "logOpsError", "実装済み", "対象外確定", "§13#10"],
  ["close_process", "getUnclockedStaffForClose", "src/domains/storeMeta/services/getUnclockedStaffForClose.ts", "58-71", "catch", "logOpsError", "実装済み", "対象外確定", "§13#11"],
  ["close_process", "getUnclosedTournamentsForClose", "src/domains/storeMeta/services/getUnclosedTournamentsForClose.ts", "175-188", "catch", "logOpsError", "実装済み", "対象外確定", "§13#12"],
  ["close_process", "getUnsettledBillsForClose", "src/domains/storeMeta/services/getUnsettledBillsForClose.ts", "94-107", "catch", "logOpsError", "実装済み", "対象外確定", "§13#13"],
